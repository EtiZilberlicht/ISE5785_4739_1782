 ...
 * Any class implementing this interface must provide a method to compute
 * intersection points with a given ray.
 */
public interface Intersectable {

    /**
     * Computes the intersection points between this geometric object and the given ray.
     *

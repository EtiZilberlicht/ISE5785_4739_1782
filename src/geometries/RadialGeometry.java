...
public abstract class RadialGeometry extends Geometry {
     ...
     * This value is immutable and represents the distance from the center 
     * to the boundary of the shape.
     */
    protected final double radius;

    /**
     * The squared radius of the geometric shape.
     * This is a precomputed value (radius * radius) for optimization purposes

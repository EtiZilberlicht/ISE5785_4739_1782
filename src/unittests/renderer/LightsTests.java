...
class LightsTests {
	...
	public void sphereMultiple() {
		scene1.geometries.add(sphere);
		scene1.lights.addAll(List.of(new DirectionalLight(new Color(GREEN), new Vector(-50, 30, -20)),
				new DirectionalLight(new Color(WHITE), new Vector(60, 30, -10)),
				new PointLight(new Color(RED), new Point(0, 70, 0)).setKL(0.0001).setKQ(0.00002),
				new PointLight(new Color(ORANGE), new Point(-50, 0, 0)).setKL(0.001).setKQ(0.0002),
				new SpotLight(new Color(147, 54, 255)/* PURPLE */, new Point(25, 15, 10), new Vector(0.5, 0, -2))
						.setKL(0.0002).setKQ(0.0003)));
	...
	public void trianglesMultiple() {
		scene2.geometries.add(triangle1, triangle2);
		scene2.lights.addAll(List.of(new DirectionalLight(new Color(RED), new Vector(-1, -1, -2)),
				new PointLight(new Color(BLUE), new Point(30, -50, -80)).setKL(0.001).setKQ(0.00002),
				new SpotLight(new Color(YELLOW), new Point(20, 10, -90), new Vector(1, 2, -1)).setKL(0.005)
						.setKQ(0.0000001)));
